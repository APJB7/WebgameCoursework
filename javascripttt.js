...
let backgroundImage = createImage('/images/gameBackground1.png')
...
function init() {
   ...
   // plant = createImage('/images/plant1.png')
    ...
    blockInstance = new Block({
        x: (platformImage.width * 10  + 360) + 2093 - scrollOffSet, // Adjust the x value to position it near the pipe
